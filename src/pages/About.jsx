            ...
            <div className="flex justify-between items-start h-[100vh] mt-[40px] sm:items-center sm:mt-[-40px] md:mt-[-80px] max-w-[1240px] mx-auto *: px-4 text-white font-coolvetica">
                <div className="mx-0 w-full gap-40 grid md:grid-cols-2 md:gap-10">
                    <div className="flex flex-col justify-center gap-4 mx-4 tracking-[4px]">
                        ...
                        <p className="text-sm">
                            Hi, I'm Daniel, a passionate web developer with a
                            love for sports. I thrive on creating high-quality
                            websites that not only meet but exceed client
                            expectations.
                        </p>
                        <p className="text-sm">
                            I dedicate myself to delivering websites that are
                            both functional and visually appealing.
                        </p>
                        <p className="text-sm">
                            Whether it's building a new site or optimizing an
                            existing one, my goal is always to provide a
                            seamless experience and bring your digital vision to
                            life.
                        </p>
                    </div>
